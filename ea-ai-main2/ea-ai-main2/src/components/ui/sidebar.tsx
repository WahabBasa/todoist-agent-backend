...
// Sidebar widths are now handled by direct Tailwind classes
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'relative w-72 bg-transparent transition-[width] duration-200 ease-linear',
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="secondary"
      size="icon"
      className={cn('size-8 mt-2 bg-background text-foreground hover:bg-muted', className)}
      onClick={event => {
        onClick?.(event)
        toggleSidebar()
      }}
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center overflow-hidden rounded-md text-left outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      ...
      attention: {
        secondary: 'text-secondary gap-secondary padding-secondary',
        tertiary: 'text-tertiary gap-tertiary padding-tertiary',
        utility: 'text-utility gap-utility padding-utility'
      }
    },
    defaultVariants: {
      variant: 'default',
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size, attention }), className)}
        {...props}
      />
    )
