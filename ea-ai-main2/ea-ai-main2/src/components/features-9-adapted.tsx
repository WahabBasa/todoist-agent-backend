                    ...
                    <div
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <span className="flex size-5 rounded-full border bg-primary">
                                    <span className="m-auto text-xs text-primary-foreground">T</span>
                                </span>
                                <span className="text-muted-foreground text-xs">Today</span>
                            </div>
                            <div className="rounded-(--radius) bg-background mt-1.5 w-3/5 border p-3 text-xs">Add meeting notes to my tasks</div>
                        </div>

                        <div>
                            <div className="rounded-(--radius) mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">I've created a new task "Meeting notes" and scheduled it for this afternoon based on your calendar.</div>
                            <span className="text-muted-foreground block text-right text-xs">Just now</span>
                        </div>
                    </div>
                </div>
                <div className="col-span-full border-y p-12">
                    <p className="text-center text-4xl font-semibold lg:text-7xl">Real-time sync</p>
                </div>
...
const chartData = [
    { month: 'May', desktop: 56, mobile: 24 },
    { month: 'June', desktop: 56, mobile: 24 },
    { month: 'January', desktop: 26, mobile: 52 },
    { month: 'February', desktop: 45, mobile: 60 },
    { month: 'March', desktop: 60, mobile: 26 },
    { month: 'April', desktop: 80, mobile: 40 },
]
