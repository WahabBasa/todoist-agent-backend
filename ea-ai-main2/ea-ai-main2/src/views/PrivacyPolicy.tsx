    ...
    <div className="min-h-screen bg-background text-foreground">
      <main className="px-6 py-12 max-w-3xl mx-auto">
        <header className="mb-8 flex items-center gap-2">
          ...
          <a href="/" className="font-semibold text-xl">Oldowan</a>
        </header>
        ...
        <section className="space-y-4 mt-8 mb-12">
          ...
          <p className="text-muted-foreground">Contact us at <a href="mailto:AtheA.hab@gmail.com" className="underline">AtheA.hab@gmail.com</a> for privacy questions or deletion requests.</p>
        </section>
      </main>
