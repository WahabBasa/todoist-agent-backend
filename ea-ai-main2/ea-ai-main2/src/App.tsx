    ...
    <div className="bg-card rounded-2xl border border-border shadow-sm p-6 max-w-sm">
      ...
      >
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-background border border-input rounded-lg hover:bg-muted/50 transition-colors text-sm font-medium text-foreground disabled:opacity-50 disabled:pointer-events-none"
        >
{isLoading ? (
